# -*- coding: utf-8 -*-
"""
Created on Mon Mar 18 16:41:36 2019

@author: 78237
"""

import sys
sys.path.insert(0, 'models-master/research/slim/')
...
convert_dataset('G:/DATA/list_train.txt', 'G:/DATA/image/', 'train/')
os.system('mkdir -p val')
convert_dataset('G:/DATA/list_val.txt', 'G:/DATA/image/', 'val/')